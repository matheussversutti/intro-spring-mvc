...
public class UsuarioController {
	...
	@PostMapping("/save")
	public String save(@ModelAttribute("usuario")Usuario usuario, RedirectAttributes ra) {
		dao.salvar(usuario);
	...
	@PostMapping("update")
	public ModelAndView Update(@ModelAttribute("usuario")Usuario usuario, RedirectAttributes ra) {
		dao.editar(usuario);
